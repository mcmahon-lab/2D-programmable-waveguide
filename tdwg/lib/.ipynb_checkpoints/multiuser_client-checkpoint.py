...
class Client:
    ...
    def hardcore_unlock(self):
        """
        This is only meant to be used with explicit in-person approval!
        For instance if a kernel got stopped with the lock in place - otherwise, don't just use this as it can lead to catastrophy!
        """
        if self.online_flag:
